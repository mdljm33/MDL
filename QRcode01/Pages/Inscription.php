      ...
      <form method="post" action="/MDL/Qrcode01/Modules/register_user.php" class="register-form">
          ...
          <div class="form-group">
              ...
              <select id="classe" name="classe" required>
                  ...
                  <option value="classe2">2nd05</option>
                  <option value="classe3">2nd06</option>
                  <option value="classe4">2nd07</option>
                  <option value="classe2">2nd08</option>
                  <option value="classe3">2nd09</option>
                  <option value="classe4">2nd11</option>
                  <option value="classe2">2nd12</option>
                  <option value="classe3">2nd13</option>
                  <option value="classe4">2nd14</option>
                  <option value="classe2">  0</option>
